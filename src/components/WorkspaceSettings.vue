...
const settings = ref({
  ...
  nodecolor: {
    ...
    default: "color",
    description:
      "The color of the nodes can be set to one of the node properties. If not set, the nodes will be blue.",
    property: "node",
  ...
  nodesize: {
    ...
    default: "val",
    description:
      'Node size set from a node property. The default is the "val" property. If set, size values will be scaled between "Node Size Max" and "Node Size Min".',
    property: "node",
    inputType: "v-text-field",
  },
  nodesizemax: {
    ...
    default: 1,
    description:
      "The maximum node size if scaling nodes using a node property.",
    property: null,
    inputType: "v-text-field",
  ...
  nodesizemin: {
    ...
    default: 1,
    description:
      "The minimum node size if scaling nodes using a node property.",
    property: null,
    inputType: "v-text-field",
    textFieldType: "number",
  },
  ...
  linkcolor: {
    ...
    default: "color",
    description:
      "Link color set from a link property. If unset, the links will be grey.",
    property: "link",
    inputType: "v-text-field",
  },
  linkwidth: {
    ...
    default: null,
    description:
      'Link width set from a link property. If set, values will be scaled between 1 and "Link Width Max".',
    property: "link",
    inputType: "v-text-field",
  },
  linkwidthmax: {
    ...
    default: 1,
    description:
      "The maximum link width if scaling link widths using a link property.",
    property: null,
    inputType: "v-text-field",
    textFieldType: "number",
  },
  directionallinks: {
    ...
    default: false,
    description:
      "Set to true to include arrows in the network graph indicating link directionality.",
    property: null,
    inputType: "v-switch",
  },
});
